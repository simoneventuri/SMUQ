...
subroutine ImportArrayInput_R41D(Input, Array, Prefix, RowMajor)
  ...
  select case (Source)
    case('external')
      ...
      call InputVerifier%AddSection(Section='file', ToSubSection=SectionName)
...
subroutine ImportArrayInput_R42D(Input, Array, Prefix, RowMajor)
  ...
  select case (Source)
    ...
    case('internal')
      ...
      call InputVerifier%AddSection(Section='array', ToSubSection=SectionName)
      call Input%FindTargetSection(TargetSection=InputSection, FromSubSection=SubSectionName, Mandatory=.true.)
...
subroutine ImportFile(Input, Strings, Prefix, Comment, Separator)
  ...
  select case (Source)
    ...
    case('internal')
      ...
      call InputVerifier%AddSection(Section='lines', ToSubSection=SubSectionName)
      call Input%FindTargetSection(TargetSection=InputSection, FromSubSection=SubSectionName, Mandatory=.true.)
      NbLines = InputSection%GetNumberofParameters()
      nullify(InputSection)
