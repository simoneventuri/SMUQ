...
module CalibrationMethod_Factory_Class
...
use CalibrationBayesian_Class                                     ,only:    CalibrationBayesian_Type

implicit none

private

public                                                                ::    CalibrationMethod_Factory

type                                                                  ::    CalibrationMethod_Factory_Type
contains
...
type(CalibrationMethod_Factory_Type)                                  ::    CalibrationMethod_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(CalibrationMethod_Type), allocatable, intent(inout)         ::    Object                                            
    ...
    select case ( LowerCase(DesiredType) )
      ...
      case('bayesian')
        allocate( CalibrationBayesian_Type :: Object )
  ...
  !!------------------------------------------------------------------------------------------------------------------------------
  subroutine Construct_Input( This, Object, Input, SectionChain, Prefix, Debug )
    
    use Input_Library

    class(CalibrationMethod_Factory_Type), intent(in)                 ::    This
    class(CalibrationMethod_Type), allocatable, intent(inout)         ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(CalibrationMethod_Type), pointer, intent(inout)             ::    Object                                            
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  !!------------------------------------------------------------------------------------------------------------------------------
  subroutine ConstructPointer_Input( This, Object, Input, SectionChain, Prefix, Debug )
  ...
  function GetOption( Object, Debug )
    ...
    class(CalibrationMethod_Type), intent(in)                         ::    Object                                             
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetObjectInput( This, Object, MainSectionName, Prefix, Directory, Debug )
    ...
    class(CalibrationMethod_Factory_Type), intent(in)                 ::    This
    class(CalibrationMethod_Type), intent(inout)                      ::    Object
