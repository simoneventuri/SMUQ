...
module ITableValueContainer_Class
...
public                                                                ::    ITableValueContainer_Type

type                                                                  ::    ITableValueContainer_Type
  class(ITableValue_Type), allocatable                                ::    Object
contains
...
subroutine Set(This, Object)
  ...
  class(ITableValueContainer_Type), intent(inout)                     ::    This
...
function Get(This)
  ...
  class(ITableValue_Type), allocatable                                ::    Get

  class(ITableValueContainer_Type), intent(in)                        ::    This
...
function GetPointer(This)
  ...
  class(ITableValue_Type), pointer                                    ::    GetPointer

  class(ITableValueContainer_Type), target, intent(in)                ::    This
...
impure elemental subroutine Copy(LHS, RHS)
  ...
  class(ITableValueContainer_Type), intent(inout)                     ::    LHS
  class(ITableValueContainer_Type), intent(in)                        ::    RHS
