...
use LinSolver_Class                                               ,only:    LinSolver_Type
...
contains
  ...
  generic, public                                                     ::    ComputeError            =>    ComputeErrorDefault
  ...
  procedure(ComputeErrorDefault_CVErrorMethod), deferred, private     ::    ComputeErrorDefault
...
abstract interface
  ...
  !!----------------------------------------------------------------------------------------------------------------------------!!
  function ComputeErrorDefault_CVErrorMethod( This, Coefficients, DesignSpace, Goal, Debug )
    use Parameters_Library
    import                                                            ::    CVErrorMethod_Type
    real(rkp)                                                         ::    ComputeErrorDefault_CVErrorMethod
    class(CVErrorMethod_Type), intent(in)                             ::    This
