...
subroutine ConstructInput(This, Input, Prefix)
  ...
  if (Input%HasSection(SubSectionName=SectionName)) then
    ...
    call InputVerifier%AddSection(Section='alpha', ToSubSection=SectionName)
    ...
    call InputVerifier%AddSection(Section='beta', ToSubSection=SectionName)
    call Input%FindTargetSection(TargetSection=InputSection, FromSubSection=SubSectionName, Mandatory=.true.)
    ...
    call InputVerifier%AddSection(Section='nfactor', ToSubSection=SectionName)
    call Input%FindTargetSection(TargetSection=InputSection, FromSubSection=SubSectionName, Mandatory=.true.)
