...
subroutine ConstructInput(This, Input, Prefix)
  ...
  do i = 1, This%NbFiles
    ...
    call InputVerifier%AddSection(Section='file' // ConvertToString(Value=i), ToSubSection=SectionName)
...
subroutine ConstructInput_FP(This, Input, Prefix)
  ...
  do i = 1, This%NbPaths
    ...
    call InputVerifier%AddSection(Section='path' // ConvertToString(Value=i), ToSubSection=SectionName)
...
function GetInput_FP(This, Name, Prefix, Directory)
  ...
  call GetInput_FP%AddSection(Section=This%PathFile%GetInput(Name=SectionName, Prefix=PrefixLoc, Directory=DirectorySub))
