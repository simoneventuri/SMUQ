...
module SurrogateMethod_Factory_Class
...
public                                                                ::    SurrogateMethod_Factory

type                                                                  ::    SurrogateMethod_Factory_Type
contains
...
type(SurrogateMethod_Factory_Type)                                    ::    SurrogateMethod_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(SurrogateMethod_Type), allocatable, intent(inout)           ::    Object                                            
  ...
  subroutine Construct_Input( This, Object, Input, SectionChain, Prefix, Debug )
    ...
    class(SurrogateMethod_Factory_Type), intent(in)                   ::    This
    class(SurrogateMethod_Type), allocatable, intent(inout)           ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(SurrogateMethod_Type), pointer, intent(inout)               ::    Object                                            
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetOption( Object, Debug )
    ...
    class(SurrogateMethod_Type), intent(in)                           ::    Object                                             
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetObjectInput( This, Object, MainSectionName, Prefix, Directory, Debug )
    ...
    class(SurrogateMethod_Factory_Type), intent(in)                   ::    This
    class(SurrogateMethod_Type), intent(inout)                        ::    Object
