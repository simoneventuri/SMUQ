...
contains
  ...
  generic, public                                                     ::    Get                     =>    ListGetR42D,            &
                                                                                                          ListGetR82D,            &
                                                                                                          ListGetI42D,            &
                                                                                                          ListGetI82D,            &
                                                                                                          ListGetC2D,             &
  ...
  generic, public                                                     ::    GetPointer              =>    ListGetR42DPointer,     &
                                                                                                          ListGetR82DPointer,     &
                                                                                                          ListGetI42DPointer,     &
                                                                                                          ListGetI82DPointer,     &
                                                                                                          ListGetC2DPointer,      &
                                                                                                          ListGetL2DPointer,      &
                                                                                                          ListGetCX2DPointer
  procedure, private                                                  ::    ListGetR42DPointer
  procedure, private                                                  ::    ListGetR82DPointer
  procedure, private                                                  ::    ListGetI42DPointer
  procedure, private                                                  ::    ListGetI82DPointer
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetR42D(This, Node, Values)
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetR82D(This, Node, Values)
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetI42D(This, Node, Values)
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetI82D(This, Node, Values)
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetR42DPointer(This, Node, Values)

  class(LinkedList2D_Type), intent(inout)                             ::    This
  real(4), dimension(:,:), pointer, intent(inout)                     ::    Values
  integer, intent(in)                                                 ::    Node

  character(*), parameter                                             ::    ProcName='ListGetR42DPointer'
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetR82DPointer(This, Node, Values)

  class(LinkedList2D_Type), intent(inout)                             ::    This
  real(8), dimension(:,:), pointer, intent(inout)                     ::    Values
  integer, intent(in)                                                 ::    Node

  character(*), parameter                                             ::    ProcName='ListGetR82DPointer'
  type(ListNode2D_Type), pointer                                      ::    NodePointerLoc=>null()
  integer                                                             ::    StatLoc=0 
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetI42DPointer(This, Node, Values)

  class(LinkedList2D_Type), intent(inout)                             ::    This
  integer(4), dimension(:,:), pointer, intent(inout)                  ::    Values
  integer, intent(in)                                                 ::    Node

  character(*), parameter                                             ::    ProcName='ListGetI42DPointer'
  type(ListNode2D_Type), pointer                                      ::    NodePointerLoc=>null()
  integer                                                             ::    StatLoc=0 
...
!!------------------------------------------------------------------------------------------------------------------------------
subroutine ListGetI82DPointer(This, Node, Values)

  class(LinkedList2D_Type), intent(inout)                             ::    This
  integer(8), dimension(:,:), pointer, intent(inout)                  ::    Values
  integer, intent(in)                                                 ::    Node

  character(*), parameter                                             ::    ProcName='ListGetI82DPointer'
  type(ListNode2D_Type), pointer                                      ::    NodePointerLoc=>null()
  integer                                                             ::    StatLoc=0 
