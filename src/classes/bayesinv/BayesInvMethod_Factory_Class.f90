...
module BayesInvMethod_Factory_Class
...
use BayesInvMCMC_Class                                            ,only:    BayesInvMCMC_Type

implicit none

private

public                                                                ::    BayesInvMethod_Factory

type                                                                  ::    BayesInvMethod_Factory_Type
contains
...
type(BayesInvMethod_Factory_Type)                                     ::    BayesInvMethod_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(BayesInvMethod_Type), allocatable, intent(inout)            ::    Object                                            
    ...
    select case ( LowerCase(DesiredType) )
      ...
      case('mcmc')
        allocate( BayesInvMCMC_Type :: Object )
  ...
  subroutine Construct_Input( This, Object, Input, SectionChain, Prefix, Debug )
    ...
    class(BayesInvMethod_Factory_Type), intent(in)                    ::    This
    class(BayesInvMethod_Type), allocatable, intent(inout)            ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(BayesInvMethod_Type), pointer, intent(inout)                ::    Object                                            
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetOption( Object, Debug )
    ...
    class(BayesInvMethod_Type), intent(in)                            ::    Object                                             
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetObjectInput( This, Object, MainSectionName, Prefix, Directory, Debug )
    ...
    class(BayesInvMethod_Factory_Type), intent(in)                    ::    This
    class(BayesInvMethod_Type), intent(inout)                         ::    Object
