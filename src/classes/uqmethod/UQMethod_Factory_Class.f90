...
use UQSampling_Class                                              ,only:    UQSampling_Type

implicit none

private

public                                                                ::    UQMethod_Factory

type                                                                  ::    UQMethod_Factory_Type
contains
...
type(UQMethod_Factory_Type)                                           ::    UQMethod_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(UQMethod_Type), allocatable, intent(inout)                  ::    Object                                            
    ...
    select case ( LowerCase(DesiredType) )
      ...
      case('sampling')
        allocate( UQSampling_Type :: Object )
  ...
  subroutine Construct_Input( This, Object, Input, SectionChain, Prefix, Debug )
    ...
    class(UQMethod_Factory_Type), intent(in)                          ::    This
    class(UQMethod_Type), allocatable, intent(inout)                  ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(UQMethod_Type), pointer, intent(inout)                      ::    Object                                            
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetOption( Object, Debug )
    ...
    class(UQMethod_Type), intent(in)                                  ::    Object                                             
    logical, optional, intent(in)                                     ::    Debug                                               
  ...
  function GetObjectInput( This, Object, MainSectionName, Prefix, Directory, Debug )
    ...
    class(UQMethod_Factory_Type), intent(in)                          ::    This
    class(UQMethod_Type), intent(inout)                               ::    Object
