...
subroutine ConstructInput(This, Input, SectionChain, Prefix)
  ...
  do i = 1, This%NbHistograms
    ...
    call InputVerifier%AddSection(Section='histogram' // ConvertToString(Value=i), ToSubSection=SectionName)
    ...
    call InputVerifier%AddSection(Section='histogram', ToSubSection=SubSectionName)
  ...
  if (Input%HasSection(SubSectionName=SectionName)) then
    ...
    do i = 1, This%NbHistograms
      ...
      call InputVerifier%AddSection(Section='bin_counts' // ConvertToString(Value=i), ToSubSection=SectionName)
      call Input%FindTargetSection(TargetSection=InputSection, FromSubSection=SubSectionName, Mandatory=.true.)
