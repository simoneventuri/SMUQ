...
contains
  ...
  !!------------------------------------------------------------------------------------------------------------------------------
  subroutine ConstructCase1( This, MaxNbFeatures, Tolerance, CVStopRatio, CVStopMinIter, CVErrorMethod, Debug )
  ...
  !!------------------------------------------------------------------------------------------------------------------------------
  subroutine SelectModelCVLOO( This, System, Goal, ModelSet, CoefficientsSet, CVError, MaxNbFeatures, Tolerance, Debug )
...
!      if ( abs(uqk)**2 / GoalVar < ToleranceLoc* ) exit
  ...
  !!------------------------------------------------------------------------------------------------------------------------------
  subroutine SelectModelCV( This, System, Goal, ModelSet, CoefficientsSet, CVError, MaxNbFeatures, Tolerance, Debug )
