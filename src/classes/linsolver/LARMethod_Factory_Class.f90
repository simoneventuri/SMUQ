...
module LARMethod_Factory_class
...
use LARBasic_Class                                                ,only:    LARBasic_Type
use LARSubSetMCV_Class                                            ,only:    LARSubSetMCV_Type

implicit none

private

public                                                                ::    LARMethod_Factory

type                                                                  ::    LARMethod_Factory_Type
contains
...
type(LARMethod_Factory_Type)                                          ::    LARMethod_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(LARMethod_Type), allocatable, intent(inout)                 ::    Object
    ...
    select case ( LowerCase(DesiredType) )
      ...
      case('basic')
        allocate( LARBasic_Type :: Object )

      case('subsetmcv')
        allocate( LARSubSetMCV_Type :: Object )
  ...
  subroutine Construct_Input( This, Object, Input, Prefix, Debug )
    ...
    class(LARMethod_Factory_Type), intent(in)                         ::    This
    class(LARMethod_Type), allocatable, intent(inout)                 ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(LARMethod_Type), pointer, intent(inout)                     ::    Object
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug
  ...
  function GetOption( Object, Debug )
    ...
    class(LARMethod_Type), intent(in)                                 ::    Object                                             
    logical, optional, intent(in)                                     ::    Debug                                               
