...
module LASSOMethod_Factory_Class
...
use LASSOBasic_Class                                              ,only:    LASSOBasic_Type
use LASSOSubSetMCV_Class                                          ,only:    LASSOSubSetMCV_Type
use LASSOSubSetOrthMCV_Class                                      ,only:    LASSOSubSetOrthMCV_Type

implicit none

private

public                                                                ::    LASSOMethod_Factory

type                                                                  ::    LASSOMethod_Factory_Type
contains
...
type(LASSOMethod_Factory_Type)                                        ::    LASSOMethod_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(LASSOMethod_Type), allocatable, intent(inout)               ::    Object
    ...
    select case ( LowerCase(DesiredType) )
      ...
      case('basic')
        allocate( LASSOBasic_Type :: Object )

!      case('subsetmcv')
!        allocate( LASSOSubSetMCV_Type :: Object )

!      case('subsetorthmcv')
!        allocate( LASSOSubSetOrthMCV_Type :: Object )
  ...
  subroutine Construct_Input( This, Object, Input, Prefix, Debug )
    ...
    class(LASSOMethod_Factory_Type), intent(in)                       ::    This
    class(LASSOMethod_Type), allocatable, intent(inout)               ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(LASSOMethod_Type), pointer, intent(inout)                   ::    Object
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug
...
!        allocate( LASSOSubSetOrthMCV_Type :: Object )
  ...
  function GetOption( Object, Debug )
    ...
    class(LASSOMethod_Type), intent(in)                               ::    Object                                             
    logical, optional, intent(in)                                     ::    Debug                                               
