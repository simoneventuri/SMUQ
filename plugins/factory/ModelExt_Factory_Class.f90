...
public                                                                ::    ModelExt_Factory

type                                                                  ::    ModelExt_Factory_Type
contains
...
type(ModelExt_Factory_Type)                                           ::    ModelExt_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType )
    ...
    class(ModelExtTemplate_Type), allocatable, intent(inout)          ::    Object                                            
  ...
  subroutine Construct_Input( This, Object, Input, Prefix )
    ...
    class(ModelExt_Factory_Type), intent(in)                          ::    This
    class(ModelExtTemplate_Type), allocatable, intent(inout)          ::    Object
    ...
    if ( Input%HasSection( SubSectionName=SectionName ) ) then
      ...
      call Input%GetValue( Value=VarC0D, ParameterName=ParameterName, Mandatory=.true. )
      call Object%Construct( CaseDir=VarC0D, Prefix=PrefixLoc )
    end if
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType )
    ...
    class(ModelExtTemplate_Type), pointer, intent(inout)              ::    Object                                            
    character(*), intent(in)                                          ::    DesiredType                                               
  ...
  function GetOption( Object )
    ...
    class(ModelExtTemplate_Type), intent(in)                          ::    Object                                                                                            
  ...
  function GetObjectInput( This, Object, MainSectionName, Prefix, Directory )
    ...
    class(ModelExt_Factory_Type), intent(in)                          ::    This
    class(ModelExtTemplate_Type), intent(inout)                       ::    Object
