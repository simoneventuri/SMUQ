...
module OFileFormated_Factory_class
...
use OFileTable_Class                                              ,only:    OFileTable_Type

implicit none

private

public                                                                ::    OFileFormated_Factory

type                                                                  ::    OFileFormated_Factory_Type
contains
...
type(OFileFormated_Factory_Type)                                      ::    OFileFormated_Factory
...
contains
  ...
  subroutine Construct_C0D( Object, DesiredType, Debug )
    ...
    class(OFileFormated_Type), allocatable, intent(inout)             ::    Object
    ...
    select case ( LowerCase(DesiredType) )
      ...
      case('table')
        allocate( OFileTable_Type :: Object )
  ...
  subroutine Construct_Input( This, Object, Input, Prefix, Debug )
    ...
    class(OFileFormated_Factory_Type), intent(in)                     ::    This
    class(OFileFormated_Type), allocatable, intent(inout)             ::    Object
  ...
  subroutine ConstructPointer_C0D( Object, DesiredType, Debug )
    ...
    class(OFileFormated_Type), pointer, intent(inout)                 ::    Object
    character(*), intent(in)                                          ::    DesiredType
    logical, optional, intent(in)                                     ::    Debug
