Module GPF_Term_PDF_Class
  ...
  private
  public  ::  GPF_Term_PDF_Type

  Type  ,extends(GPF_Term_Type) ::  GPF_Term_PDF_Type
    private
    type(GPF_Font_Type)   ::  Font                      !< Terminal Font object
  contains
    private
    procedure   ,public   ::  Initialize    =>  InitializeTermPDF
    procedure   ,public   ::  Set_Command   =>  SetCommandTermPDF
    procedure   ,public   ::  GetName
  End Type

  Interface

    Module Subroutine InitializeTermPDF( This, Color, FontName, FontSize, Enhanced, Extension, Title, Dashed, Persist, Size, Debug )
      class(GPF_Term_PDF_Type)                              ,intent(inout)  ::  This                            !< Terminal object to be constructed
    ...
    Module Pure Function GetName( This ) result(Name)
      class(GPF_Term_PDF_Type)                              ,intent(in)     ::  This
      character(:)  ,allocatable                                            ::  Name
    End Function

    Module Subroutine SetCommandTermPDF( This )
      class(GPF_Term_PDF_Type)                              ,intent(inout)  ::  This                            !< Passed-object dummy argument corresponding to the Terminal object
    End Subroutine
