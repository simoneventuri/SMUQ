...
Module Procedure FreeLoggerItem
  ...
  This%Index             =   0
  This%Indentation       =   0
  This%LogLevel          =   LogLevel_DEFAULT
  This%SavedLogLevel     =   LogLevel_DEFAULT
  This%MsgLogLevel       =   LogLevel_DEFAULT
  This%SavedMsgLogLevel  =   LogLevel_DEFAULT
End Procedure
...
Module Procedure IndentLoggerItem
  use Logger_Parameters ,only:  IndentationStep
...
Module Procedure SetMsgLogLevel
  use Logger_Parameters ,only:  LogLevel_DEFAULT
  This%MsgLogLevel   =   LogLevel_DEFAULT                                                                   ! Setting the default message log level to the default value
...
Module Procedure IsLoggerItemActive
  ...
  if ( present(ActiveProcedures) ) then
    if ( IsPresent( This%Name, ActiveProcedures ) ) Active = .True.
  end if
End Procedure
