...
function(add_pFUnit_executable name pf_file_list output_directory
  ...
  set ( DEBUG_PREFIX "-[add_pFUnit_executable]:" )
#   LogMessage( "${DEBUG_PREFIX} name: ${name}" )
#   LogMessage( "${DEBUG_PREFIX} pf_file_list: ${pf_file_list}" )
#   LogMessage( "${DEBUG_PREFIX} output_directory: ${output_directory}" )
...
#   LogMessage( "${DEBUG_PREFIX} fortran_source_list: ${fortran_source_list}" )

  # Create the executable itself.
#   LogMessage( "${DEBUG_PREFIX} add_executable( ${name} ${fortran_source_list} )" )
  add_executable( ${name} ${fortran_source_list} )

  # Handle pFUnit linking.
#   LogMessage( "${DEBUG_PREFIX} target_link_libraries(${name} ${PFUNIT_LIBRARIES})" )
...
#     set(MY_COMMAND ./${executable_name})
    set(MY_COMMAND ${executable_name})    # Lopez
  endif()

  # Prefix command with an mpirun command
  set (MY_COMMAND ${PFUNIT_MPIRUN} ${MY_COMMAND})
  set (MY_COMMAND ${PFUNIT_MPIRUN} ${MY_COMMAND} -robust  -xml ${executable_name}.xml ) # Lopez
